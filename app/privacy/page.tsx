  ...
  return (
    <main id="main-content">
      ...
      <article className="container legal-document">
        ...
        <h2>7. AI 전화상담</h2>
        <p>AI 전화상담을 이용하는 경우 발신번호, 상담 중 확인한 주소, 대표 증상과 선택적으로 확인된 제조사·모델명을 서비스 신청 접수에 사용합니다. 상담 종료 전 컴박사 AI 상담원이 상담을 진행했다는 사실을 안내합니다.</p>
        <p>통화 후 웹사이트에는 서비스 신청에 필요한 구조화된 항목과 중복 방지를 위한 통화 식별값만 저장하며, 전체 통화 내용, 녹음 파일과 녹음 URL은 저장하지 않습니다. 음성 변환과 통화 후 분석 과정에서는 TryVox의 처리 및 보존 설정이 적용됩니다.</p>
        <h2>8. 파기와 안전조치</h2>
