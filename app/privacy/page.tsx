  ...
  return (
    <main id="main-content">
      ...
      <article className="container legal-document">
        ...
        <h2>2. 수집 항목</h2>
        <p>필수: 연락처, 기본 주소, 기기 종류, 대표 증상 및 신청 조회 비밀번호 또는 자동 조회코드의 해시. 선택: 이름, 상세 주소, 제조사·모델명, 상세 접수 내용. 이름을 입력하지 않으면 ‘미상’으로 저장합니다.</p>
        <h2>3. 처리 법적 근거</h2>
        ...
        <h2>5. 내 신청 조회</h2>
        <p>전체 신청 목록은 공개하지 않습니다. 휴대전화 번호와 직접 지정한 신청 비밀번호 또는 자동 발급된 조회코드가 모두 일치하는 경우에만 10분 동안 본인의 신청을 조회할 수 있습니다. 비밀번호와 조회코드 원문은 저장하지 않습니다.</p>
        <h2>6. Telegram 신규접수 알림 및 국외 처리</h2>
        <p>운영자의 접수 확인을 위해 Telegram Bot API로 접수번호, 기기 종류, 전체 연락처, 기본 주소와 대표 증상을 전송합니다. 이름, 상세 주소, 상세 접수 내용과 조회 비밀번호·코드는 전송하지 않습니다.</p>
