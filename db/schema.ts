...
export const blogPosts = sqliteTable(
  "blog_posts",
  {
    ...
    evidenceCards: text("evidence_cards").notNull().default("[]"),
...
export const requestOperations = sqliteTable(
  "request_operations",
  {
    ...
    totalVatAmount: integer("vat_amount").notNull().default(0),
    materialVatAmount: integer("material_vat_amount").notNull().default(0),
