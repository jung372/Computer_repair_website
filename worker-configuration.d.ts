/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6f4383be0caedde6afb923ad5b7cabd4)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_BUSINESS_EMAIL">> {}
}
